    ...
    const setTransactionsAndGraphs = (wD) => {
        ...
        for (const w of wD) {
            ...
            if (tradesData[0].managerID) {
                trades =
                    tradesData.find((t) => t.managerID == w.managerID)
                        ?.trades || 0;
            } else if (tradesData[0].rosterID) {
                trades =
                    tradesData.find((t) => t.rosterID == w.rosterID)?.trades ||
                    0;
            }
            ...
            <Head>
                <Row class="rTableHeader">
                    <Cell class="header headerPrimary" colspan="4"
                        >{prefix}
                        {key == "playoffData" ? "Playoff " : ""}Single Week
                        Scoring Records</Cell
                    >
                </Row>
                <Row>
                            ...
                            <div class="vsRecord">
                                <div
                                    on:click={() =>
                                        gotoManager({
                                            year:
                                                closestMatchup.home.year ||
                                                prefix,
                                            leagueTeamManagers,
                                            rosterID:
                                                closestMatchup.home.rosterID,
                                            managersObj: managers,
                                        })}
                                >
                                    <RecordTeam
                                ...
                                <div
                                    on:click={() =>
                                        gotoManager({
                                            year:
                                                closestMatchup.away.year ||
                                                prefix,
                                            leagueTeamManagers,
                                            rosterID:
                                                closestMatchup.away.rosterID,
                                            managersObj: managers,
                                        })}
                                >
                                    <RecordTeam
...
{#if graphs.length}
    <BarChart {graphs} bind:curGraph {leagueTeamManagers} {managers} />
{/if}
                ...
                <DataTable class="rankingTable">
                    <Head>
                        <Row>
                            <Cell class="header headerPrimary" colspan="5">
                                {prefix}
                                {key == "playoffData" ? "Playoff " : ""}Lineup
                                IQ Rankings
                                <div class="subTitle">
                                    The percentage of potential points each
                ...
                <Head>
                    <Row>
                        <Cell class="header headerPrimary" colspan="6"
                            >{prefix}
                            {key == "playoffData" ? "Playoff " : ""}Win
                            Percentages Rankings</Cell
                        >
                    </Row>
                    <Row>
                        <Cell class="header" />
            ...
            <DataTable class="rankingTable">
                <Head>
                    <Row>
                        <Cell class="header headerPrimary" colspan="5">
                            {prefix}
                            {key == "playoffData" ? "Playoff " : ""}Fantasy
                            Points Rankings
                        </Cell>
                    </Row>
                    <Row>
